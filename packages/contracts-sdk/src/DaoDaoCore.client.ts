...
import {InstantiateMsg, ExecuteMsg, Config, QueryMsg, MigrateMsg, AdminNominationResponse, Cw20BalanceResponse, DaoURIResponse, PauseInfoResponse, DumpStateResponse, GetItemResponse, InfoResponse, ProposalModuleCountResponse, TotalPowerAtHeightResponse, VotingPowerAtHeightResponse} from "./DaoDaoCore.types";
...
export interface DaoDaoCoreInterface extends DaoDaoCoreReadOnlyInterface {
  ...
  acceptAdminNomination: (_fee?: number | StdFee | "auto", _memo?: string, _funds?: Coin[]) => Promise<ExecuteResult>;
  withdrawAdminNomination: (_fee?: number | StdFee | "auto", _memo?: string, _funds?: Coin[]) => Promise<ExecuteResult>;
  updateConfig: ({
    config
  }: {
    config: Config;
...
export class DaoDaoCoreClient extends DaoDaoCoreQueryClient implements DaoDaoCoreInterface {
  ...
  acceptAdminNomination = async (_fee: number | StdFee | "auto" = "auto", _memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      accept_admin_nomination: {}
    }, _fee, _memo, _funds);
  };
  withdrawAdminNomination = async (_fee: number | StdFee | "auto" = "auto", _memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
