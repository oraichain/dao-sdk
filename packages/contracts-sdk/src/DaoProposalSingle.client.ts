...
import {InstantiateMsg, ExecuteMsg, QueryMsg, MigrateMsg, VoteResponse, InfoResponse, ProposalListResponse, ProposalResponse, VoteListResponse, HooksResponse} from "./DaoProposalSingle.types";
